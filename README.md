![Trusting the robot: using the power of git to automate your releases](title.png)

# Slide and Code
This repo is divided into multiple branches to help organize. 

This branch focuses on the Nx demo of my talk. 
...
Libraries are shareable across libraries and applications. They can be imported from `@semantic-release-demo/mylib`.
